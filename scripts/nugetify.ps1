...
Param
(
    $sitecoreVersion = '8.2.161221', # NuGet package version to convert to. Format is major.minor.releasedate.
    $frameworkVersion = 'net461' # for 8.2: net452. For 7.0-8.1: net45
)
